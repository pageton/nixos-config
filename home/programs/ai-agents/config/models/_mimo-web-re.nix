# Web RE agent definition for MiMoCode.
# Mirrors _opencode-web-re.nix; mimo shares opencode's agent schema.
# The launcher pins default_agent=web-re per-session via MIMOCODE_CONFIG_DIR overlay.
...
in
{
  "web-re" = {
    ...
    prompt = ''
      ...
      scripts/ai/web-re/mimo-web-re.sh       — MiMoCode launcher (used by mi*wre aliases)
