...
}:
{
  programs.ghostty = {
    ...
    settings = {
      ...
      cursor-color = constants.color.yellow;
      cursor-text = constants.color.bg_hard;
      cursor-opacity = 1;
      ...
      mouse-scroll-multiplier = "precision:2,discrete:5";
      ...
      split-divider-color = constants.color.bg1;
