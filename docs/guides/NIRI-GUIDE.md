...
| 2   | 󰨞 editor    | VSCode, Alacritty (auto-start) | `Super+2`           |
...
| --- | -------------------- | ------------------------------ | --------------------------- |
| 1   | `Super+Return`       | Terminal (Alacritty + Zellij)  | Need a terminal             |
...
| Key                  | What It Does                                        |
| -------------------- | --------------------------------------------------- |
| `Super+Return`       | Terminal (Alacritty with Zellij)                    |
| `Super+Shift+Return` | Terminal (bare Alacritty)                           |
...
| Transparency (92%)   | Alacritty, kitty, foot              | Slight see-through for terminals    |
